...
import logo from '../images/NS.jpg';
...
export default function Sidebar() {
  ...
  const iconList = [
    {
      component: github,
      href: 'https://github.com/codernisha'
    },
    {
      component: linkedin,
      href: 'https://www.linkedin.com/in/nishantmar1998'
    },
    {
      component: gmail,
      href: 'mailto:nishantmar1998@gmail.com'
    }
  ];
  const item = {
  ...
  return (
    <div className='sidebar'>
      ...
      <div className='topHashtag'># developer_life</div>
      <div className='topHashtag'># coder_life</div>
